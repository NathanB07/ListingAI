...
function ListingAI() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0c0a06", color: "#f0ebe0", fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
      <style>{`
      ...
      {/* FORM VIEW */}
      {view === "form" && (
        <div style={{ maxWidth: "820px", margin: "0 auto", padding: "44px 40px" }} className="fade-in">
